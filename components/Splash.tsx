...
export const Splash: React.FC<SplashProps> = ({ onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-[#21274E] flex flex-col items-center justify-center text-white overflow-hidden">
      ...
      <div className="flex flex-col items-center space-y-0 mb-12 relative z-10">
        ...
        <div className={`transition-all duration-1000 transform ${step >= 1 ? 'translate-y-0 opacity-100 scale-100' : '-translate-y-20 opacity-0 scale-90'}`}>
          <div className="relative">
            ...
            <div className="bg-white/5 backdrop-blur-2xl p-6 rounded-full shadow-[0_0_60px_rgba(255,255,255,0.05)] w-48 h-48 flex items-center justify-center border border-white/20 relative overflow-hidden">
              <img 
                src="https://i.postimg.cc/44pJ0vXw/logo.png" 
                alt="Windmar Home" 
                className="w-32 h-32 object-contain relative z-10 drop-shadow-[0_0_15px_rgba(248,155,36,0.3)]"
              />
              {/* Tech accents */}
        ...
        <div className={`transition-all duration-1200 transform ${step >= 1 ? 'translate-y-0 opacity-100 scale-90 rotate-0' : 'translate-y-20 opacity-0 scale-50 rotate-180'}`}>
          <div className="relative">
            ...
            <div className="bg-white/10 backdrop-blur-2xl p-3 rounded-full shadow-[0_0_80px_rgba(248,155,36,0.15)] w-32 h-32 flex items-center justify-center relative overflow-hidden border border-white/30">
              <img 
                src="https://lumapr.com/wp-content/uploads/2021/01/Luma-Blue-1.png" 
                alt="LUMA Energy" 
                className="w-16 h-16 object-contain relative z-10 drop-shadow-[0_0_15px_rgba(255,255,255,0.8)] brightness-0 invert"
              />
              {/* Rotating Tech Ring */}
      ...
      <div className={`transition-all duration-800 delay-500 text-center transform ${step >= 1 ? '-translate-y-4 opacity-100' : 'translate-y-10 opacity-0'}`}>
        <div className="flex items-center justify-center mb-8">
          ...
          />
          <h1 className="text-[47.5px] sm:text-[63.5px] font-black tracking-tighter text-[#F89B24] leading-none">
            SCANNER
          </h1>
        </div>
